...
/**
 * Base de la API (dominio canónico sin www: el www redirige con 307 y los POST
 * pierden el cuerpo). En dev puedes apuntar a tu local con EXPO_PUBLIC_API_URL
 * (las variables EXPO_PUBLIC_* se inyectan en el bundle). Por defecto usa producción.
 */
export const API_URL = process.env.EXPO_PUBLIC_API_URL ?? "https://cursumi.com";
