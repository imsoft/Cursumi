...
export { FourthSection } from './indexPage/FourthSection';
export { FifthSection } from './indexPage/FifthSection';

export { Footer } from './shared/Footer';
export { HeaderMenu } from './shared/HeaderMenu';
...
export { CanvasConfetti } from './ui/CanvasConfetti';
