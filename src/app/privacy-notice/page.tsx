        ...
        <div className="relative overflow-hidden bg-white py-16">
          <div className="relative px-6 lg:px-8">
            <div className="mx-auto max-w-prose text-lg">
              <h1>
                <span className="block text-center text-lg font-semibold text-purple-500">
                  Cursumi
                </span>
            ...
            <div className="max-w-screen-lg mx-auto mt-6 text-gray-500">
              <p>
                Brandon Uriel Garcia Ramos mejor conocido como cursumi.com, con
                domicilio en Guadalajara, Jalisco, México y portal de internet
                cursumi.com/privacy-notice, es el responsable del uso y
              ...
              <p>
                ...
                cualquier servicio solicitado, Envío de productos adquiridos en
              ...
              <br />
              <p>Datos de identificación y contacto</p> <br />
              <h2 className="font-bold">
              ...
              <p>
                ...
                teach.in.cursumi@gmail.com y deberá contener:
              </p>
              <br />
              ...
              <p>
                ...
                cursumi.com/privacy-notice.
              </p>
              <br />
              <p>
                Última actualización de este aviso de privacidad: 04/07/2023
              </p>
              <br />
            </div>
          </div>
